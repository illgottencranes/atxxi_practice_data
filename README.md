...
* [Section 1](#1.0---Definition-of-terms) - General definitions, how to prepare the data, which bits are more important to fill out
* [Section 2](#2.0---Setting-up-with-R-and-Rstudio) - Link to the guide, how the code is organized, what to do with the files after
* [Section 3](#3.0---Overview-of-the-produced-files) - Longer descriptions of what’s in each .csv produced by the code
